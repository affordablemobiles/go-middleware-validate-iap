...
type emailValFunc func(*http.Request, string) (bool, error)
...
func GetValidateIAPMiddleware(emailVal emailValFunc) negroni.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
		if claims, err := jwt.RequestClaims(r, cfg); err != nil {
			...
			if ok, err := emailVal(r, claims.Email); err != nil {
...
func emailNotEmpty(r *http.Request, email string) (bool, error) {
	if email != "" {
		return true, nil
	}
